...
export class SlidersComponent implements OnInit {
    ...
    getSliders() {
        this.httpService.makeRequest(Constants.GET_SLIDERS, Constants.HTTP_GET, {}, (err, res) => {
            if (!err && res) {
    ...
    deleteSlider(id) {
        ...
        this.httpService.makeRequest(Constants.GET_SLIDERS + 'delete/' + id, Constants.HTTP_POST, body, (err, res) => {
            if (!err && res) {
                if (res.status === 200) {
