...
const toast_container_component_1 = require("./toast-container.component");
const toast_options_1 = require("./toast-options");
const toast_1 = require("./toast");
const Subject_1 = require("rxjs/Subject");
const ToastsManager = (function () {
    ...
    ToastsManager.prototype.show = function (toast, options) {
        ...
        return new Promise(function (resolve, reject) {
            if (!_this.container) {
                ...
                const providers = core_1.ReflectiveInjector.resolve([
                    { provide: toast_options_1.ToastOptions, useValue: _this.options }
                ]);
                // create and load ToastContainer
                const toastFactory = _this.componentFactoryResolver.resolveComponentFactory(toast_container_component_1.ToastContainer);
                const childInjector = core_1.ReflectiveInjector.fromResolvedProviders(providers, _this._rootViewContainerRef.parentInjector);
